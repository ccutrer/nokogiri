    ...
    module XMLSec
      class TestEncryption < Nokogiri::TestCase
        ...
        def test_encrypt_single_element
          ...
          node.encrypt(key: @public_key, block_encryption: "aes128-cbc", key_transport: "rsa-1_5")
          ...
          encrypted_data.decrypt(key: @private_key)
        ...
        def test_certificate_insertion
          ...
          doc = @xml
          doc.encrypt(key: File.read(File.join(ASSETS_DIR, "xmlsec/certificates/server.key.decrypted")),
